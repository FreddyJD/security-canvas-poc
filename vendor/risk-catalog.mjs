...
export const DETECTION_CATALOG = {
    ...
    earlyLifeMaliciousActivity: {
        ...
        impact: "Strongly suggests the agent was created by an attacker rather than compromised later. Check who created it.",
        weight: 0.9,
    ...
    suspiciousCredentialUsage: {
        ...
        impact: "Classic persistence mechanism — an attacker adds their own secret so they retain access after a password reset.",
        weight: 0.8,
...
//# sourceMappingURL=risk-catalog.js.map